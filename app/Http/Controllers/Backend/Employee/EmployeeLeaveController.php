...
class EmployeeLeaveController extends Controller
{
    ...
    public function EmployeeLeaveStore(Request $request) {
        ...
        $data->save();
        $notification = array(
            'message' => 'Employee Leave Purpose Successfully Added',
            'alert-type' => 'success'
        );
    ...
    public function EmployeeLeaveUpdate(Request $request, $id) { 
        ...
        $data->save();
        $notification = array(
            'message' => 'Employee Leave Purpose Successfully Updated',
            'alert-type' => 'success'
        );
        return Redirect()->route('employee.leave.view')->with($notification);
    }
    ...
    public function EmployeeLeaveDelete($id) {
        ...
        $leave->delete();
        $notification = array(
            'message' => 'Employee Leave Purpose Successfully Deleted',
            'alert-type' => 'success'
        );
        return Redirect()->route('employee.leave.view')->with($notification);
    }
