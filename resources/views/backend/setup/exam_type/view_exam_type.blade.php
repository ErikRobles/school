                          ...
                          <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('exam.type.edit', $exam_type->id) }}" class="btn btn-rounded btn-primary">Edit</a>
                                        <a href="{{ route('exam.type.delete', $exam_type->id) }}" class="btn btn-rounded btn-danger" id="delete">Delete</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
