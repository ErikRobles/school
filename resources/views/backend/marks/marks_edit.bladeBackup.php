                    ...
                    <form action="{{ route('marks.entry.store') }}" method="POST">
                        ...
                        <div class="row d-none mt-4" id="marks-entry">
                            <div class="col-md-12">
                                ...
                                <input type="submit" class="btn btn-rounded btn-primary" name="" value="Update">
                            </div>
                        </div>
       ...
       $.ajax({
        ...
        success: function (data) {
          ...
          $.each( data, function(key, v){
            ...
            '<td><input type="text" class="form-control form-control-sm" id="roll-gen-input" name="marks[]" value=" '+v.marks +' "></td>'+
            '</tr>';
          });
